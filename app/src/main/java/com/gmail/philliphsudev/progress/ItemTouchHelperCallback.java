...
public class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public boolean isLongPressDragEnabled() {
        if (mListener instanceof TaskAdapter) {
            TaskAdapter ta = (TaskAdapter) mListener;
            return ta.currentTaskList() instanceof CustomTaskList && ta.isSortedByMyOrder();
        }
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if (mListener instanceof TaskListAdapter) {
            ...
            if (TaskListDb.isPrimary(viewHolder.getAdapterPosition())) {
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        // What I thought to do to try clearing RTL swipe...
        /*View itemView = viewHolder.itemView;
        Canvas c = new Canvas();
        Paint p = new Paint();
    ...
    public boolean canDropOver(RecyclerView recyclerView, RecyclerView.ViewHolder current, RecyclerView.ViewHolder target) {
        ...
        if (mListener instanceof TaskListAdapter) {
            ...
            boolean isDraggingNonPrimaryListToPrimaryPos =
                    !TaskListDb.isPrimary(current.getAdapterPosition())
                    && TaskListDb.isPrimary(target.getAdapterPosition());
